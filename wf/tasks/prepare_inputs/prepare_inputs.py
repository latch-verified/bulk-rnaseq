...
from wf.core.errors import (InsufficientCustomGenomeResources,
                            MalformedSalmonIndex)
from wf.core.models import LatchGenome, Sample, TrimgaloreSalmonInput
from wf.core.types import FastaFile, GtfFile
from wf.core.utils import remote_output_dir, run, unzip_if_needed
